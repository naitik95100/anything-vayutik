  ...
  // ── 1. OPENROUTER ──────────────────────────────────────────────────────────
  {
    ...
    modelList: [
      ...
      },
      {
        ...
        capabilities: ['text', 'code', 'vision'],
        contextWindow: '1M',
        description: "Google's latest flash model — free",
        free: true,
      },
      {
        ...
        capabilities: ['text', 'code', 'vision'],
        contextWindow: '2M',
        description: '2M context multimodal Google model',
      },
      {
      ...
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '131K',
        description: "xAI's frontier model with real-time X data",
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '128K',
        description: "Alibaba's multilingual frontier model",
        free: true,
      },
      {
        id: 'microsoft/phi-4',
    ...
    modelList: [
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '128K',
        description: "Meta's latest 70B model — versatile & fast",
        free: true,
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '128K',
        description: 'Smallest Llama, fastest response times',
        free: true,
      },
      {
      ...
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '32K',
        description: 'Mistral MoE model on Groq LPU',
        free: true,
      },
      {
        id: 'gemma2-9b-it',
      ...
      },
      {
        ...
        capabilities: ['text'],
        contextWindow: '8K',
        description: 'Safety classification model',
        free: true,
      },
      {
        ...
        capabilities: ['text', 'code', 'reasoning'],
        contextWindow: '128K',
        description: 'DeepSeek R1 distilled on Groq',
        free: true,
      },
      {
        id: 'qwen-2.5-32b',
        ...
        capabilities: ['text', 'code'],
        contextWindow: '128K',
        description: "Alibaba's Qwen 2.5 on Groq LPU",
        free: true,
      },
      {
        id: 'mistral-saba-24b',
        ...
        capabilities: ['text', 'code'],
        contextWindow: '32K',
        description: 'Mistral Saba model on Groq',
        free: true,
      },
    ],
    get models() { return ids(this.modelList); },
  ...
  // ── 3. GOOGLE AI STUDIO ────────────────────────────────────────────────────
  {
    ...
    modelList: [
      ...
      },
      {
        ...
        capabilities: ['text', 'code', 'vision'],
        contextWindow: '1M',
        description: 'Fast multimodal model — best price/performance',
        free: true,
      },
      {
        id: 'gemini-2.0-flash',
        ...
        contextWindow: '1M',
        description: 'Next-gen multimodal with real-time streaming',
        free: true,
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '1M',
        description: 'Lightest and fastest Gemini 2.0 model',
        free: true,
      },
      {
        id: 'gemini-1.5-pro',
        ...
        capabilities: ['text', 'code', 'vision', 'audio'],
        contextWindow: '2M',
        description: '2M context multimodal model',
      },
      {
        id: 'gemini-1.5-flash',
      ...
      },
      {
        ...
        capabilities: ['text', 'code'],
        contextWindow: '1M',
        description: 'Most affordable Gemini model',
        free: true,
      },
    ],
    get models() { return ids(this.modelList); },
